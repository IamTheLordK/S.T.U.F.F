...
local Box = Instance.new("TextBox", Instance.new("ScreenGui", game.Players.LocalPlayer.PlayerGui))

Box.Parent.ResetOnSpawn = false
...
if not Char or not Humanoid or not Seat then return end
